...
const BottomNavbar = () => {
  ...
  return (
    <nav className="fixed border-t bg bd bottom-0 left-0 right-0 h-[98px] bg-white shadow-lg">
      <div className="flex items-center h-full justify-around">
        ...
        >
          ...
          <span className="text-xs txt">Home</span>
        </Link>
...
>
          ...
          <span className="text-xs txt">Events</span>
        </Link>
...
>
          ...
          <span className="text-xs txt">Speaker</span>
        </Link>
...
>
          ...
          <span className="text-xs txt">Reports</span>
        </Link>
...
>
          ...
          <span className="text-xs txt">Profile</span>
        </Link>
      </div>
    </nav>
  );
