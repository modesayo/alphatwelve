...
interface NavItem {
  id: number;
  name: string;
  path: string; // Path for routing (if needed)
  icon: JSX.Element | null;
  icon1: JSX.Element | null; // Icon for the navigation item
  action?: () => void;
  render?: () => JSX.Element;
}
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M10.4583 11.2917L13.375 14L10.4583 16.7083M14.625 11.2917L17.5416 14L14.625 16.7083"
            stroke="#64748B"
            strokeWidth="1.5"
            strokeLinecap="round"
           strokeLinejoin="round"
          ...
          <li key={item.id} className="">
            <a
              ...
              onClick={(e) => {
                ...
                if (item.action) item.action(); // Call the action if defined
              }}
